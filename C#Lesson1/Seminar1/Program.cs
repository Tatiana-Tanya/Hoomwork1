...
// Задача 6 Напиши программу,которая на вход принемает число и выдает,является ли число четным(делится ли оно на два без остатка)  
   */    
   /*  
{  
    int i;  
...
{  
  ...
  */ 
   // Задача 10 Напишите программу,которая принемает на вход трехзначное число и на выходе цифру этого числа.  
